...
For documentation files, use hyphens in filenames:
- `docs/getting-started.md` NOT `docs/getting_started.md`
- `docs/api-reference.md` NOT `docs/api_reference.md`
- `docs/energy-theory.md` NOT `docs/energy_theory.md`
...
- `docs/spec_realisation.md` - Specification system details
